...
public abstract class BaseActivity extends AppCompatActivity implements ComponentCallbacks2 {
    ...
    protected void showApiProgressDialog(IProgress progress, String message, boolean isCanceledOnTouch) {
        progress.showProgressDialog(this, message, isCanceledOnTouch);
    }


    protected void dismissApiProgressDialog(IProgress progress) {
        progress.hideProgressDialog(this);
    }
